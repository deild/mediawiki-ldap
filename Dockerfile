...
&& curl -sS https://extdist.wmflabs.org/dist/extensions/LDAPProvider-REL1_39-a3c56fa.tar.gz -o /tmp/LDAPP.tar.gz \
&& tar xf /tmp/LDAPP.tar.gz -C /var/www/html/extensions \
&& rm -rf /tmp/LDAPP.tar.gz \
&& curl -sS https://extdist.wmflabs.org/dist/extensions/LDAPAuthorization-REL1_39-07d09d8.tar.gz -o /tmp/LDAPA.tar.gz \
&& tar xf /tmp/LDAPA.tar.gz -C /var/www/html/extensions \
&& rm -rf /tmp/LDAPA.tar.gz \  
&& curl -sS https://extdist.wmflabs.org/dist/extensions/PluggableAuth-REL1_39-e952f13.tar.gz -o /tmp/PlugA.tar.gz \
&& tar xf /tmp/PlugA.tar.gz -C /var/www/html/extensions \
&& rm -rf /tmp/PlugA.tar.gz \
&& curl -sS https://extdist.wmflabs.org/dist/extensions/LDAPAuthentication2-REL1_39-835a45a.tar.gz -o /tmp/LDAPA2.tar.gz \
...
&& curl -sS https://extdist.wmflabs.org/dist/extensions/Quiz-REL1_39-e22bd98.tar.gz -o /tmp/Quiz.tar.gz \
...
&& curl -sS https://extdist.wmflabs.org/dist/extensions/Auth_remoteuser-REL1_39-b9c4b86.tar.gz -o /tmp/Auth_remoteuser.tar.gz \
&& tar xf /tmp/Auth_remoteuser.tar.gz -C /var/www/html/extensions \
&& rm -rf /tmp/Auth_remoteuser.tar.gz \
&& curl -sS https://extdist.wmflabs.org/dist/extensions/DarkMode-REL1_39-8df7dea.tar.gz -o /tmp/DarkMode.tar.gz \
