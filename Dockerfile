...
RUN 	curl -S https://extdist.wmflabs.org/dist/extensions/PluggableAuth-REL1_35-e5976c0.tar.gz -o /tmp/PlugA.tgz && \
...
RUN 	curl -S https://extdist.wmflabs.org/dist/extensions/Quiz-REL1_35-8ac7d81.tar.gz -o /tmp/Quiz.tgz && \
